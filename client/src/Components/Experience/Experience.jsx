            ...
            <div className='exp'>
                <div className='experience'>
                    <div className='experience_image'>
                        <img src='https://cdnjobs.net/cached_uploads/fit/140/140/2020/09/29/214124-png-1601389804.png' />
                    </div>
                    <h2>RBK program</h2>
                ...
                <div className='experience'>
                    <div className='experience_images'>
                        <img src='https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTOlTXxM6h--ZY5pmFiOD1RulikXptXKlisxw&usqp=CAU' />
                    </div>
